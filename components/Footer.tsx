    ...
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <div className="relative h-10 w-10 mr-3">
                <Image src="/images/logo-light.png" alt="Company Logo" fill className="object-contain" />
              </div>
              <span className="text-white text-xl font-bold">XaideZ</span>
            </div>
            <p className="text-sm text-gray-400">
              Your trusted source for kashmiri delicacies and food items. We pride ourselves on excellent customer
          ...
          {/* Main Links */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">Main Navigation</h3>
          ...
          {/* Policies */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">Policies & Information</h3>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <li>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-gray-500 mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} XaideZ. All rights reserved.
            </div>
            <div className="text-sm text-gray-500">Designed and developed by AP Freelance Solutions</div>
          </div>
        </div>
      </div>
