        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <button className="w-full py-2 px-4 bg-green-500 text-white font-medium rounded-md hover:bg-xaidez-accent transition-colors flex items-center justify-center gap-2">
