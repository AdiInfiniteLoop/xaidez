          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800  line-clamp-2 h-10 lg:h-6">{product.title}</h3>

                <p className="text-base text-gray-600 mb-2 line-clamp-2 lg:hidden">{product.subtitle}</p>
              </div>
